		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hola Mundo",
									"targetURL": "#logaligroupholamundo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupholamundo-display": {
								"semanticObject": "logaligroupholamundo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.holamundo",
									"url": sap.ui.require.toUrl("logaligroup/holamundo")
								}
							}
						}
					}
